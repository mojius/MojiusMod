...
public class ModifiedBowItem extends ShootableItem {
   public ModifiedBowItem(Item.Properties builder) {
      super(builder);
      this.addPropertyOverride(new ResourceLocation("pull"), (p_210310_0_, p_210310_1_, p_210310_2_) -> {
         if (p_210310_2_ == null) {
            return 0.0F;
         } else {
            return !(p_210310_2_.getActiveItemStack().getItem() instanceof ModifiedBowItem) ? 0.0F : (float)(p_210310_0_.getUseDuration() - p_210310_2_.getItemInUseCount()) / 20.0F;
         }
      });
         ...
         if (!itemstack.isEmpty() || flag) {
            ...
            if (!((double)f < 0.1D)) {
               ...
               if (!worldIn.isRemote) {
                  ...
                  if (flag1 || playerentity.abilities.isCreativeMode && (itemstack.getItem() == Items.SPECTRAL_ARROW || itemstack.getItem() == Items.TIPPED_ARROW || itemstack.getItem() == InitItem.tnt_arrow)) {
