...
public class ModifiedMeleeAttackGoal extends Goal {
   ...
   public ModifiedMeleeAttackGoal(CreatureEntity creature, double speedIn, boolean useLongMemory) {
   ...
   public boolean shouldExecute() {
      ...
      if (i - this.field_220720_k < 20L) {
         ...
         {
        	 this.attacker.setLastAttackedEntity(this.attacker.getAttackTarget());
         }
         else if (livingentity == null)
         {
       	  livingentity = this.attacker.getLastAttackedEntity();
       	  if ((livingentity != null) && (!(this.attacker.getDistance(livingentity) < (float)this.attacker.getAttribute(SharedMonsterAttributes.FOLLOW_RANGE).getBaseValue())))
       	  {
       		  livingentity = null;
       	  }
         }
